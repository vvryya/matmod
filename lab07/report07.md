...
2.2 Написала программу на Modelica:
'''
model lab0702
...
В ходе выполнения данной лабораторной работы я построила график распространения рекламы.
